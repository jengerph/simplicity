...
///////////////////////////////////////////////////////////////////////////////
//
// htdocs/base/manage/billing/once_off/index.php - View Billing: Pending Action
// $Id$
//
///////////////////////////////////////////////////////////////////////////////
//
...
if ($user->class == 'customer') {
  ...
  $pt->setFile(array("outside" => "base/outside3.html", "main" => "base/manage/billing/once_off/pending_action/index.html"));
  
} else if ($user->class == 'admin') {
  
  $pt->setFile(array("outside" => "base/outside1.html", "main" => "base/manage/billing/once_off/pending_action/index.html"));
...
$total_entries = $service_billing_once_off->get_num_rows_no_wua($user->class,$user->access_id);
...
$once_off_arr = $service_billing_once_off->get_no_wua($user->class,$user->access_id,$start,$end);
...
$pt->setVar("PAGE_TITLE", "View Once-Off Billing Pending Action");
