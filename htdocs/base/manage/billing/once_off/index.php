...
///////////////////////////////////////////////////////////////////////////////
//
// htdocs/base/manage/billing/once_off/index.php - View Billing
// $Id$
//
///////////////////////////////////////////////////////////////////////////////
//
...
if ($user->class == 'customer') {
  ...
  $pt->setFile(array("outside" => "base/outside3.html", "main" => "base/manage/billing/once_off/index.html"));
  
} else if ($user->class == 'admin') {
  
  $pt->setFile(array("outside" => "base/outside1.html", "main" => "base/manage/billing/once_off/index.html"));
...
$total_entries = $service_billing_once_off->get_num_rows($user->class,$user->access_id);
...
$once_off_arr = $service_billing_once_off->get_all_no_id($user->class,$user->access_id,$start,$end);
