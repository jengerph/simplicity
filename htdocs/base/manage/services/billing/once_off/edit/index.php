...
///////////////////////////////////////////////////////////////////////////////
//
// htdocs/base/manage/services/billing/once_off/edit/index.php - Edit Billing Once Off
// $Id$
//
///////////////////////////////////////////////////////////////////////////////
//
...
if ($user->class == 'customer') {
  ...
  $pt->setFile(array("outside" => "base/outside3.html", "main" => "base/manage/services/billing/once_off/edit/index.html"));
  
} else if ($user->class == 'admin') {
  
  $pt->setFile(array("outside" => "base/outside1.html", "main" => "base/manage/services/billing/once_off/edit/index.html"));
...
if ( isset($_REQUEST["submit"]) ) {
  ...
  if ( $validate != 0 ) {
    ...
    $url = "";
        ...
        $url .= $_SERVER["SERVER_NAME"] . ':' . $_SERVER['SERVER_PORT'] . "/base/manage/services/billing/once_off/?service_id=".$service_billing_once_off->service_id;
