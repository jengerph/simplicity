...
///////////////////////////////////////////////////////////////////////////////
//
// htdocs/base/manage/services/billing/index.php - View Billing
// $Id$
//
///////////////////////////////////////////////////////////////////////////////
//
...
if ($user->class == 'customer') {
  ...
  $pt->setFile(array("outside" => "base/outside3.html", "main" => "base/manage/services/billing/index.html"));
  
} else if ($user->class == 'admin') {
  
  $pt->setFile(array("outside" => "base/outside1.html", "main" => "base/manage/services/billing/index.html"));
...
if ( isset($_REQUEST["submit"]) ) {
  ...
  if ( $validate != 0 ) {
    ...
    $url = "";
        ...
        $url .= $_SERVER["SERVER_NAME"] . ':' . $_SERVER['SERVER_PORT'] . "/base/manage/services/?service_id=".$service->service_id;
