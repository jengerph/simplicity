...
include_once "../outbound_voice/delivery_address/servicequalify.php";
...
if ($user->class == 'customer') {
	...
	$pt->setFile(array("outside" => "base/outside2.html", "main" => "base/manage/services/edit/extras/index.html"));
	
} else if ($user->class == 'reseller') {
  $pt->setFile(array("outside" => "base/outside3.html", "main" => "base/manage/services/edit/extras/index.html"));
  
} else if ($user->class == 'admin') {
  $pt->setFile(array("outside" => "base/outside1.html", "main" => "base/manage/services/edit/extras/index.html"));
  ...
  if (!trim($_REQUEST["street_name"])) {
    ...
    if ( is_array($qualify_array) ) {
      ...
      if ( !isset($address_verify[0]["siteAddress"]) ) {
        ...
        $_SESSION["extras"]["delivery_address"] = trim($delivery_address);
        $_SESSION["extras"]["delivery_address"] = strtoupper($delivery_address);
        ...
        if ( isset($_SERVER["HTTPS"]) ) {
          ...
          $url .= $_SERVER["SERVER_NAME"] . ':' . $_SERVER['SERVER_PORT'] . "/base/manage/services/edit/extras/creation/?service_id=" . $service->service_id;
...
$pt->setVar("PAGE_TITLE", "Edit - Service Extras");
