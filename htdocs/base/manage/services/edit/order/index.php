...
///////////////////////////////////////////////////////////////////////////////
//
// htdocs/base/manage/services/edit/order/index.php - Qualify Order
// $Id$
//
///////////////////////////////////////////////////////////////////////////////
//
...
include_once "../../add/servicequalify.php";
...
if ($user->class == 'customer') {
  ...
  $pt->setFile(array("outside" => "base/outside2.html", "main" => "base/manage/services/edit/order/index.html"));
  ...
  $pt->setFile(array("outside" => "base/outside3.html", "main" => "base/manage/services/edit/order/index.html"));
  
} else if ($user->class == 'admin') {
  $pt->setFile(array("outside" => "base/outside1.html", "main" => "base/manage/services/edit/order/index.html"));
  
}

// Assign the templates to use
$pt->setFile(array("service_option" => "base/manage/wholesalers/service_option.html","fnn_section" => "base/manage/services/edit/order/fnn_yes.html"));
...
for ($a=0; $a < count($serv_list); $a++) { 
  $order = new orders();
  $order->service_id = $serv_list[$a]["service_id"];
  $order->open_load();
...
if ( isset($_REQUEST['submit']) ) {
  if ( $_REQUEST["fnn_service"] ) {
      if ( $_REQUEST["fnn_service"] == "yes" ) {
        $pt->setFile(array("fnn_section" => "base/manage/services/edit/order/fnn_yes.html"));
      } else {
        $pt->setFile(array("fnn_section" => "base/manage/services/edit/order/fnn_no.html"));
      }
    }
}
...
if ( $on_going_order == 0 ) {
  ...
  } else if ( $on_going_order >= 1 ) {
    $pt->setVar("ERROR_MSG", "ERROR: You can only file one order at a time.");
  }
}
...
function goto_next(){
  // Done, goto list
    ...
    $url .= $_SERVER["SERVER_NAME"] . ':' . $_SERVER['SERVER_PORT'] . "/base/manage/services/edit/order/qualify/index.php?service_id=" . $_REQUEST["service_id"];
