...
///////////////////////////////////////////////////////////////////////////////
//
// htdocs/base/manage/services/edit/adsl_nbn/order/qualify/index.php - confirm Results
// $Id$
//
///////////////////////////////////////////////////////////////////////////////
//
...
if ($user->class == 'customer') {
  ...
  $pt->setFile(array("outside" => "base/outside2.html", "main" => "base/manage/services/edit/adsl_nbn/order/qualify/index.html"));
  ...
  $pt->setFile(array("outside" => "base/outside3.html", "main" => "base/manage/services/edit/adsl_nbn/order/qualify/index.html"));
  
} else if ($user->class == 'admin') {
  $pt->setFile(array("outside" => "base/outside1.html", "main" => "base/manage/services/edit/adsl_nbn/order/qualify/index.html"));
...
if ( isset($_REQUEST["submit"]) ) {
  ...
  // Done, goto list
    ...
    $url .= $_SERVER["SERVER_NAME"] . ':' . $_SERVER['SERVER_PORT'] . "/base/manage/services/edit/adsl_nbn/order/qualify/confirm/?service_id=" . $_REQUEST["service_id"];
