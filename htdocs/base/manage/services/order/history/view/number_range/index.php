...
if ($user->class == 'customer') {
	...
	$pt->setFile(array("outside" => "base/outside1.html", "main" => "base/manage/services/order/history/view/number_range/index.html"));
...
$pt->setFile(array("number_range_rows" => "base/manage/orders/edit/number_range/number_range_rows.html",
					...
					"back_link_number_range" => "base/manage/services/order/history/view/number_range/back_link_number_range.html"));
...
$customers->customer_id = $services->customer_id;
$customers->load();
