...
if (isset($_REQUEST['submit2'])) {
    ...
    if (isset($_REQUEST['location_id'])) {
        ...
        if (sizeof($results) == 1) {
            ...
            $pt->setFile(array("location_id" => "base/manage/services/add/opticomm/location_id.html", "location_id_row" => "base/manage/services/add/opticomm/location_id_row.html"));

            foreach ($results as $result) {

                $displayAddress = $result->lot_no . " " . $result->unit_no . " " . $result->house_no . "<br />"
                    . $result->street_type . " " . $result->street_name . "<br />"
                    . $result->suburb . " " . $result->state_name . " " . $result->postcode;

                $pt->setVar('LOCATION_ID', $result->property_id);
                $pt->setVar('LOCATION_TEXT', $displayAddress);
