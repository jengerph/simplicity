...
function servicequal_address1($address){
  ...
  $params['address']['subAddressType'] = $address['subAddressType'];
  $params['address']['subAddressNumber'] = $address['subAddressNumber'];
...
// $params['address']['postcode'] = '3109';
  ...
  //echo "REQUEST:\n" . $client->__getLastRequest() . "\n";
  $response_arr = $response->serviceProviderLocationList->serviceProviderLocationList->locationList->addressInformation;
 ...
 */ 
  ...
  $ret = array();
  while ($cel = each($new_response)) {

	$ret[] = servicequal_address2($cel['value']->serviceProvider, $cel['value']->locationId, $cel['value']->displayAddress);
...
function servicequal_address2($serviceProvider,$id, $displayAddress = ''){
  ...
  $arr['nbnLocationID'] = $response->siteDetails->nbnLocationID;
  $arr['dslCodesOnLine'] = $response->siteDetails->dslCodesOnLine;
  $arr['displayAddress'] = $displayAddress;
