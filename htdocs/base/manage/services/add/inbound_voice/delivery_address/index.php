...
///////////////////////////////////////////////////////////////////////////////
//
// htdocs/base/manage/services/add/inbound_voice/delivery_address/index.php - Inbound Voice
// $Id$
//
///////////////////////////////////////////////////////////////////////////////
//
...
if ($user->class == 'customer') {
	...
	$pt->setFile(array("outside" => "base/outside2.html", "main" => "base/manage/services/add/inbound_voice/delivery_address/index.html"));
	
} else if ($user->class == 'reseller') {
  $pt->setFile(array("outside" => "base/outside3.html", "main" => "base/manage/services/add/inbound_voice/delivery_address/index.html"));
  
} else if ($user->class == 'admin') {
  $pt->setFile(array("outside" => "base/outside1.html", "main" => "base/manage/services/add/inbound_voice/delivery_address/index.html"));
...
if ( isset($_REQUEST["submit"]) ) {
  ...
  if ( isset($qualify_array[0]['siteAddress']->postcode) ) {
      ...
      if ( empty($sub_premises) ) {
        ...
        $delivery_address = "";
            ...
            if ( isset($_SERVER["HTTPS"]) ) {
              ...
              $url .= $_SERVER["SERVER_NAME"] . ':' . $_SERVER['SERVER_PORT'] . "/base/manage/services/add/inbound_voice/?customer_id=" . $customer->customer_id . "&sp=" . $session_pointer0;
...
$pt->setVar("PAGE_TITLE", "Inbound Voice: Delivery Address");
