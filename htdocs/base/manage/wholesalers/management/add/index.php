...
///////////////////////////////////////////////////////////////////////////////
//
// htdocs/base/manage/wholesalers/management/add/index.php - Add Plan
// $Id$
//
///////////////////////////////////////////////////////////////////////////////
//
...
if ($user->class == 'customer') {
  ...
  exit();
	...
	$pt->setFile(array("outside" => "base/outside3.html", "main" => "base/manage/wholesalers/management/add/index.html"));
	
} else if ($user->class == 'admin') {
	$pt->setFile(array("outside" => "base/outside1.html", "main" => "base/manage/wholesalers/management/add/index.html"));
...
if ( isset($_SERVER["HTTP_REFERER"]) ) {
  if ( strpos($_SERVER["HTTP_REFERER"], "base/manage/wholesalers/management/add/") !== false ) {
