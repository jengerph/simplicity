...
///////////////////////////////////////////////////////////////////////////////
//
// htdocs/base/manage/wholesalers/management/edit/index.php - Edit Plans
// $Id$
//
///////////////////////////////////////////////////////////////////////////////
//
...
if ($user->class == 'customer') {
  ...
  exit();
	...
	$pt->setFile(array("outside" => "base/outside3.html", "main" => "base/manage/wholesalers/management/edit/index.html"));
	
} else if ($user->class == 'admin') {
	$pt->setFile(array("outside" => "base/outside1.html", "main" => "base/manage/wholesalers/management/edit/index.html"));
