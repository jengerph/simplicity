...
$rec_count = 0;
$rec_count++;
$output[] = make_transfer($rec_count, "0398415846", '099', $date);
$rec_count++;
$output[] = make_transfer($rec_count, "0746130770", '099', $date);
$rec_count++;
$output[] = make_transfer($rec_count, "0398747117", '099', $date);
$rec_count++;
$output[] = make_transfer($rec_count, "0862538910", '099', $date);
$rec_count++;
$output[] = make_transfer($rec_count, "0394576751", '099', $date);
